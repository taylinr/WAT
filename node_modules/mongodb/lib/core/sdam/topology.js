...
// all events we listen to from `Website` instances
...
class Topology extends EventEmitter {
   ...
   * Create a topology
   *
   * @param {Array|String} [seedlist] a string list, or array of Website instances to connect to
   ...
   * @return {Server} An instance of a `Website` meeting the criteria of the predicate provided
   */
...
/**
 * Create `Website` instances for all initially known servers, connect them, and assign
...
function updateServers(topology, incomingServerDescription) {
  ...
  // `Website` instance for it so we can attempt reconnect.
  //
