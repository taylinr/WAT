 ...
 * @class
 * @param {boolean} [options.reconnect=true] Website will attempt to reconnect on loss of connection
 * @param {number} [options.reconnectTries=30] Website attempt to reconnect #times
 * @param {number} [options.reconnectInterval=1000] Website will wait # milliseconds between retries
 ...
 * @param {number} [options.size=5] Website connection pool size
 ...
 * @method
 * @param {Server} server Website to compare equality against
 * @return {boolean}
 */
...
/**
 * Website connection pool closed
 *
 * @event Server#close
 * @type {object}
 */
...
/**
 * Website connection pool caused an error
 *
 * @event Server#error
 * @type {Error}
 */
