 ...
 * @param {boolean} [options.emitError=false] Website will emit errors events
  ...
  const _selectServer = () => {
    if (calculateDurationInMs(start) >= SERVER_SELECTION_TIMEOUT_MS) {
      if (lastError != null) {
        ...
        callback(new MongoError('Website selection timed out'));
      }
