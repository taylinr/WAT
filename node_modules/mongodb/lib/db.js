 ...
 * @param {(Website|ReplSet|Mongos)} topology The server topology for the database.
 ...
 * @property {(Website|ReplSet|Mongos)} serverConfig Get the current db topology.
 ...
 * Db reconnect event
 *
 *  * Website: Emitted when the driver has reconnected and re-authenticated.
 *  * ReplicaSet: N/A
 ...
 *
 * * Website: Emitted when the driver has connected to the single server and has authenticated.
